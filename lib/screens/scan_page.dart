...
class ScanPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final walletsToScanRow = Row(
      // MODIFICATION: On desktop, this row doesn't need to be centered.
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // The Stack now correctly fills the remaining space
                Expanded(
                  child: Stack(
                    children: [
                      // The log panel itself
                      Padding(
                        padding: const EdgeInsets.only(bottom: 15.0), // Space for the navbar area
                        child: logsPanel.child, // Use the child of the Expanded widget
                      ),
                      // The FAB is positioned relative to the Stack
                      Positioned(
                        bottom: 30, // 15px margin from the bottom of the log panel
                        right: 15, // 15px margin from the right of the log panel
